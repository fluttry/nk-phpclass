...
<body>
    ...
    <header
        ...
        <a class="btn btn-outline-primary" href="<?php echo $username;?>">fb Chat</a>
    </header>
    <div class="masthead text-center text-white purple p-4">
        <div class="masthead-content">
            <div class="container">
                <h1 class="masthead-heading mb-0">Hello there !</h1>
                <h2 class="masthead-subheading mb-0"><?php echo $username;?></h2>
    ...
    <footer class="align-items-center p-3 px-md-4 mt-3 bg-white border-top shadow-sm">
        ...
        <p>&copy; 2022<?php echo $username;?> <a href="/project.html">Project</a> &middot; <a
